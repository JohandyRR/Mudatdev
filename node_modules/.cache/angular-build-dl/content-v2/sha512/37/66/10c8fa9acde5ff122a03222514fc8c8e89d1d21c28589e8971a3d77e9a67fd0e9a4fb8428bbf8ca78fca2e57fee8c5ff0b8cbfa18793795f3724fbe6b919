(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-signup-signup-module"], {
    ...
    function srcAppPagesSignupSignupPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _ionic_native_app_preferences_ngx__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! @ionic-native/app-preferences/ngx */
      "./node_modules/@ionic-native/app-preferences/__ivy_ngcc__/ngx/index.js");

      var SignupPage = /*#__PURE__*/function () {
        function SignupPage(router, preference, navCtr, formbuilder, authService, loadingCtrl, alertCtrl) {
          ...
          this.validationMessages = {
            ...
            password: [{
              type: "required",
              message: "password is required here"
            }, {
              type: "minlength",
              message: "Passwrd must be at least 6 character"
            }]
          };
        ...
        _createClass(SignupPage, [{
          ...
          value: function ngOnInit() {
            this.ValidationFormUSer = this.formbuilder.group({
              names: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])),
            ...
            try {
              this.authService.userRegistration(value).then(function (response) {
                ...
                if (response.user) {
                  ...
                  _this.preference.store(value.phone, 'userPhoneNumber');
